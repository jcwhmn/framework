...
@Constraint(validatedBy = Exist.UniqueValidator.class)
@Documented
public @interface Exist {
  ...
  String field();
  String message() default "数据存在验证";
  Class<?>[] groups() default {};
  Class<? extends Payload>[] payload() default {};

  public class UniqueValidator implements ConstraintValidator<Exist, String> {
